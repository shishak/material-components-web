...
export class MDCToolbar extends MDCComponent {
  ...
  get fixedAdjustElement_() {
    return document.querySelector(MDCToolbarFoundation.strings.FIXED_ADJUST_SELECTOR);
  }
  ...
  getDefaultFoundation() {
    return new MDCToolbarFoundation({
      ...
      setStyleForFixedAdjustElement: (property, value) => this.fixedAdjustElement_.style[property] = value,
    });
  }
}
